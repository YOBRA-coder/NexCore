...
export function Footer() {
  ...
  return (
    <footer style={{ background:"var(--bg)",borderTop:"1px solid rgba(139,92,246,.08)",padding:"4rem 1.5rem 2.5rem" }}>
      <div style={{ maxWidth:1320,margin:"0 auto" }}>
        ...
        <div style={{ borderTop:"1px solid var(--b)",paddingTop:"1.75rem",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"1rem" }}>
